...
{
    public string[] EnabledItems { get; set; } = ["Delay", "Escape", "Invisibility", "Invincibility", "Offset"];
    ...
    public SerializedVector3 Offset { get; set; } = new SerializedVector3(0, 500, 0);
